  ...
  return (
    <div className="min-h-screen w-full font-sans text-[#140000] selection:bg-[#FFB6A3] selection:text-[#140000]" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="blob w-[500px] h-[500px] rounded-full bg-[#FFB6A3] -top-20 -left-20 animate-pulse" style={{ animationDuration: '10s' }}></div>
        <div className="blob w-[400px] h-[400px] rounded-full bg-[#FC69C3] bottom-0 right-0 opacity-40" style={{ animationDuration: '12s' }}></div>
      </div>
      ...
      {/* Hero Section */}
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-10 pb-20 lg:pt-20 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          {/* Waitlist Form */}
          <div className="max-w-md glass-card p-6 rounded-2xl shadow-xl shadow-[#FFB6A3]/10">
            {status === 'success' ? (
        ...
        <div className="relative hidden lg:block h-[800px] w-full">
          ...
          <div className="absolute top-0 right-20 w-[300px] h-[600px] bg-white rounded-[40px] border-[8px] border-[#140000] shadow-2xl overflow-hidden animate-float z-20">
            {/* Status Bar */}
          ...
          <div className="absolute top-20 right-0 w-[280px] h-[550px] bg-gray-50 rounded-[40px] border-[8px] border-[#E06052]/20 shadow-xl overflow-hidden animate-float-delayed z-10 opacity-90 scale-95 origin-bottom-right">
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="border border-[#E5E5E5] rounded-2xl overflow-hidden transition-all duration-300 hover:border-[#FFB6A3]"
              >
                <button
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 bg-[#FAFAFA] border-t border-[#E5E5E5] relative overflow-hidden">
